...
def inferenceByLikelihoodWeightingSamplingRandomSource(randomSource=None):
...
inferenceByLikelihoodWeightingSampling = inferenceByLikelihoodWeightingSamplingRandomSource()
